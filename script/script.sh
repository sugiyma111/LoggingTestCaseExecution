...
# 選択したディレクトリでテスト実行
mvn -DargLine="-Xmx8g -Xms2048m -javaagent:${current_dir}/selogger-0.6.0.jar=format=omni,weaverlog=log.txt,output={time},weave=EXEC+CALL,e=org/junit,e=org/apache/maven,e=org/opentest4j" test
